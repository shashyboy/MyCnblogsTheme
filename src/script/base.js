...
//----------------------------- Loading 前后逻辑处理 ----------------------------------//
    ...
    this.loadingAfterInit = function () {
        ...
        // 设置菜单个人简介头像
        var blogAvatar = window.cnblogsConfig.blogAvatar ? window.cnblogsConfig.blogAvatar : 'https://cdn.jsdelivr.net/gh/shashyboy/MyCnblogsTheme@master/img/webp/default_avatar.webp';
                ...
                $.each(feedbackItem, function (i) {
                    ...
                    if (idInfo && idInfo.length > 0) {
                        ...
                        var op = $('#comment_' + id + '_avatar'), patch  = op.length > 0 ? $.trim(op.text())
                            : 'https://cdn.jsdelivr.net/gh/shashyboy/MyCnblogsTheme@master/img/webp/default_avatar.webp';
