...
if (initCheck()) {
    ...
    window.cnblogsConfigDefault = {
        ...
        homeTopImg: [
            "https://cdn.jsdelivr.net/gh/shashyboy/MyCnblogsTheme@master/img/webp/home_top_bg.webp"
        ],
        homeBannerText: "",
        homeBannerTextType: "jinrishici",
        essayTopImg: [
            "https://cdn.jsdelivr.net/gh/shashyboy/MyCnblogsTheme@master/img/webp/nothome_top_bg.webp"
        ],
...
function getVersionConfig() {
    ...
    } else if(window.cnblogsConfig.GhUserName === 'shashyboy') {
        window.themeVersion = [
            [
                "v1.1.6",
